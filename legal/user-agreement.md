...
These terms and conditions apply to the Emojily app (hereby referred to as the "Application") for mobile devices that was created by Gheorghe Cojocaru (hereby referred to as the "Service Provider") as a Freemium service.
...
By using the Application, you accept responsibility for any such charges, including roaming data charges if you use the Application outside of your home territory (for example, region or country) without disabling data roaming. If you are not the bill payer for the device on which you are using the Application, it is assumed that you have obtained permission from the bill payer.

## Device Responsibility and Accuracy
...
The Service Provider may also wish to cease providing the Application and may terminate its use at any time without providing termination notice to you. Unless they inform you otherwise, upon any termination, the rights and licenses granted to you in these terms will end, you must cease using the Application, and if necessary, delete it from your device.
...
If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at [support@Emojily.app](mailto:support@Emojily.app).
